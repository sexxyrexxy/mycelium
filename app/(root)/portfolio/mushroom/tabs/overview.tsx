    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[65%_35%] gap-6 mb-6">
            ...
            <CardContent>
              <div className="flex justify-between items-center">
                <div className="text-center flex-1">
                  ...
                  <p className="text-green-500 font-bold text-lg">Strong Signal</p>
                </div>
        ...
        <div className="lg:col-span-2 w-full">
          ...
          >
            <span className="text-lg font-semibold">Understanding Mushroom Electrical Signals</span>
            <span className={`transform transition-transform duration-300 ${open ? "rotate-90" : ""}`}>
              &#9654;
            </span>
          </div>
          ...
          >
            <ul className="bg-[#564930] rounded-md p-2 space-y-2">
              <li className="flex flex-col gap-1 p-2 rounded-md">
                <span className="text-lg text-white font-semibold">What are they?</span>
                <span className="text-base text-white">
                  Mushrooms, like many living organisms, use tiny electrical impulses to communicate internally 
                  and respond to their environment. These electrical signals are small changes in voltage that flow 
                  through the fungal network, similar to how neurons transmit signals in animals. By measuring these signals, 
                  we can see how active a mushroom is, how it reacts to stimuli, and possibly determine how healthy it is 
                  overall.
                </span>
              </li>
              <li className="flex flex-col gap-1 p-2 rounded-md">
                <span className="text-lg text-white font-semibold">Why are they Important?</span>
                <ul className="list-disc list-inside text-base text-white space-y-1">
                  <li>Monitoring Activity: By measuring these signals, we can see when a mushroom is active or responding to changes in its environment.</li>
                  <li>Assessing Health: Healthy mushrooms show distinct patterns in their electrical activity; deviations can indicate stress or problems.</li>
                  <li>Understanding Fungal Networks: Studying these signals helps scientists and cultivators understand how mushrooms communicate and interact within a network.</li>
                </ul>
              </li>
